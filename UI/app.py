...
app.layout = html.Div([
    ...
    html.H2('Room1'),   
    html.Div([
        html.Div(id='room1-temp', className='average-box'),  
        html.Div(id='room1-humidity', className='average-box'),  
        html.Div(id='room1-co2', className='average-box'), 
    ], style={'display': 'flex', 'justify-content': 'center'}),

    html.H2('Room1'),
    html.Div([
        html.Div(id='room2-temp', className='average-box'),  
        html.Div(id='room2-humidity', className='average-box'),  
        html.Div(id='room2-co2', className='average-box'), 
    ], style={'display': 'flex', 'justify-content': 'center'}),
...
#     with open('UI\\room1.json', 'r') as json_file:
#         room1_data = json.load(json_file)
    
#     # Read JSON data from room2.json
#     with open('UI\\room2.json', 'r') as json_file:
...
@app.callback(
    Output('room1-temp', 'children'),  # Update the content of the div
    [Input('update-button', 'n_clicks')]  # Specify the button as an input
)
def update_room1_temp(n_clicks):
    ...
    return html.Div([
        html.Div(f'Temperature:', className='room1-label', style={'font-weight': 'bold', 'padding-top':'21px'}),
        html.Div(f'{average:.2f}', className='room1-temp', style={'font-size': '20px', 'padding-bottom': '13px'})
    ], className= background)

@app.callback(
    Output('room1-humidity', 'children'),  # Update the content of the div
    [Input('update-button', 'n_clicks')]  # Specify the button as an input
)
def update_room1_humidity(n_clicks):
       # Read data from both JSON files
    data = []
    ...
    return html.Div([
        html.Div(f'Humidity:', className='room1-label', style={'font-weight': 'bold', 'padding-top':'21px'}),
        html.Div(f'{average:.2f}', className='room1-humidity', style={'font-size': '20px', 'padding-bottom': '13px'})
    ], className= background)
    
@app.callback(
    Output('room1-co2', 'children'),  # Update the content of the div
    [Input('update-button', 'n_clicks')]  # Specify the button as an input
)
def update_room1_co2(n_clicks):
       # Read data from both JSON files
    data = []
    ...
    return html.Div([
        html.Div(f'CO2:', className='room1-label', style={'font-weight': 'bold', 'padding-top':'21px'}),
        html.Div(f'{average:.2f}', className='room1-co2', style={'font-size': '20px', 'padding-bottom': '13px'}),
    ], className=background)

@app.callback(
    Output('room2-temp', 'children'),  # Update the content of the div
    [Input('update-button', 'n_clicks')]  # Specify the button as an input
)

def update_room2_temp(n_clicks):
    # Read data from both JSON files
    data = []
    ...
    return html.Div([
        html.Div(f'Temperature:', className='room2-label', style={'font-weight': 'bold', 'padding-top':'21px'}),
        html.Div(f'{average:.2f}', className='room2-temp', style={'font-size': '20px', 'padding-bottom': '13px'})
    ], className= background)

@app.callback(
    Output('room2-humidity', 'children'),  # Update the content of the div
    [Input('update-button', 'n_clicks')]  # Specify the button as an input
)
def update_room2_humidity(n_clicks):
       # Read data from both JSON files
    data = []
    ...
    return html.Div([
        html.Div(f'Humidity:', className='room2-label', style={'font-weight': 'bold', 'padding-top':'21px'}),
        html.Div(f'{average:.2f}', className='room2-humidity', style={'font-size': '20px', 'padding-bottom': '13px'})
    ], className= background)

@app.callback(
    Output('room2-co2', 'children'),  # Update the content of the div
    [Input('update-button', 'n_clicks')]  # Specify the button as an input
)
def update_room2_co2(n_clicks):
       # Read data from both JSON files
    data = []
    ...
    return html.Div([
        html.Div(f'CO2:', className='room2-label', style={'font-weight': 'bold', 'padding-top':'21px'}),
        html.Div(f'{average:.2f}', className='room2-co2', style={'font-size': '20px', 'padding-bottom': '13px'}),
    ], className=background)
